(function(c){"function"===typeof define&&define.amd?define(["jquery","DataTables-1.10.18.net","DataTables-1.10.18.net-buttons"],function(f){return c(f,window,document)}):"object"===typeof exports?module.exports=function(f,b){f||(f=window);if(!b||!b.fn.dataTable)b=require("DataTables-1.10.18.net")(f,b).$;b.fn.dataTable.Buttons||require("DataTables-1.10.18.net-buttons")(f,b);return c(b,f,f.document)}:c(jQuery,window,document)})(function(c,f,b,n){var i=c.fn.dataTable,e=b.createElement("a"),m=function(a){e.href=a;a=e.host;-1===a.indexOf("/")&&
