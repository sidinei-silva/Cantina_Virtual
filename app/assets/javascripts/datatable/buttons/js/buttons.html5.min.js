(function(i){"function"===typeof define&&define.amd?define(["jquery","DataTables-1.10.18.net","DataTables-1.10.18.net-buttons"],function(j){return i(j,window,document)}):"object"===typeof exports?module.exports=function(j,l,v,u){j||(j=window);if(!l||!l.fn.dataTable)l=require("DataTables-1.10.18.net")(j,l).$;l.fn.dataTable.Buttons||require("DataTables-1.10.18.net-buttons")(j,l);return i(l,j,j.document,v,u)}:i(jQuery,window,document)})(function(i,j,l,v,u,s){function z(a){for(var b="";0<=a;)b=String.fromCharCode(a%26+65)+b,a=Math.floor(a/
