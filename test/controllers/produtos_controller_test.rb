...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { descricao_produto: @produto.descricao_produto, esta_ativo: @produto.esta_ativo, nome_produto: @produto.nome_produto, preco_produto: @produto.preco_produto } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { descricao_produto: @produto.descricao_produto, esta_ativo: @produto.esta_ativo, nome_produto: @produto.nome_produto, preco_produto: @produto.preco_produto } }
